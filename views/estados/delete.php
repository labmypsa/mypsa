                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=destroy" role="form">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre" class="form-control" id="nombre"  disabled="" placeholder="nombre" value="<?php echo ucwords($data['estado'][0]['nombre']); ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="paises_id">Pais</label>
                                                <select disabled="" autofocus="" id="paises_id" class="form-control select2" style="width: 100%;" name="paises_id" required="">
