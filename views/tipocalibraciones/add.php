                                    ...
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name; ?>&a=store" role="form">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input autofocus type="text" class="form-control" name="desctc" id="nombre" placeholder="Nombre" value="" required="">
                                            </div>
                                            <div class="form-group">
                                                <label for="idestado">Sucursal</label>
                                                <select autofocus="" id="idsucursal" class="form-control select2" style="width: 100%;" name="idsucursal" required="">
