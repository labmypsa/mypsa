                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=update" role="form">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus required="" class="form-control" id="desctc" name="desctc" placeholder="nombre" value="<?php echo $data['tipocalibracion'][0]['desctc']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="idpais">Sucursal</label>
                                                <select autofocus="" id="idpais" class="form-control select2" style="width: 100%;" name="idsucursal" required="">
