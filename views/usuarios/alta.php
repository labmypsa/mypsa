...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Listado de <?php echo $this->name; ?> / Alta</h3>
                                    <a href="?c=<?php echo $this->name; ?>&a=add" class="btn btn-primary btn-md pull-right btn-flat">Agregar nuevo</a>
                                </div>
                                <!-- /.box-header -->
                                <div class="box-body">

                                    <table id="table_alta"   class="table table-bordered table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th># id</th>
                                                <th>Nombre</th>
        ...
        <script>
            $('#table_alta tfoot th').each( function () {
                var title = $(this).text();
