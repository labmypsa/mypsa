                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=update" role="form">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" autofocus required="" class="form-control" id="nombre" name="nombre" placeholder="nombre" value="<?php echo $data['ciudad'][0]['nombre']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="idpais">Estado</label>
                                                <select autofocus="" id="estados_id" class="form-control select2" style="width: 100%;" name="estados_id" required="">
