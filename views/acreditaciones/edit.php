                                    ...
                                    <form method="POST" autocomplete="off"  action="?c=<?php echo $this->name; ?>&a=update" role="form">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" style="width: 100%;" id="sucursales_id" name="sucursales_id" required="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="" name="nombre" class="form-control" id="nombre" placeholder="Descripcion" value="<?php echo $data['acreditacion'][0]['nombre']; ?>">
                                            </div>
                                            <div class="form-group">
