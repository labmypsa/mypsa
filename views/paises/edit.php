                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=update" role="form">
                                        <input type="hidden" name="id" value="<?php echo $data['pais'][0]['id']; ?>">
                                        <div class="box-body">
                                            <div class="form-group">
                                                <label for="id">Número de identificación</label>
                                                <input type="text" class="form-control" id="id" name="id" placeholder="id" disabled="" value="<?php echo $data['pais'][0]['id']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nombre">Nombre</label>
                                                <input type="text" autofocus required="" class="form-control" id="nombre" name="nombre" placeholder="nombre" value="<?php echo ucwords($data['pais'][0]['nombre']); ?>">
                                            </div>
                                        </div>
