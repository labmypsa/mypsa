                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=destroy" role="form">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input disabled="" autofocus type="text" class="form-control" name="alias" id="alias" placeholder="Id de equipo" value="<?php echo $data['equipo'][0]['alias'] ?>" required="">
                                            </div>
                                            <div class="form-group">
                                                <label for="serie">Número de serie</label>                                                    
                                                <input disabled="" autofocus type="text" class="form-control" name="serie" id="serie" placeholder="Número de serie" value="<?php echo $data['equipo'][0]['serie'] ?>"  required="">
                                            </div>
                                            <div class="form-group">
                                                <label for="descripciones_id">Descripción</label>
                                                <select disabled="" class="form-control select2" name="descripciones_id" id="descripciones_id"  required="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled="" class="form-control select2" name="marcas_id" id="marcas_id" required="">
                                                    <option value="">Seleccione una opción</option>
                                                <?php
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select disabled="" class="form-control select2" name="modelos_id" id="modelos_id" required="">
                                                    <option value="">Seleccione una opción</option>
                                                <?php
