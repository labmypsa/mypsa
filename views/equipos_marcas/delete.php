                                    ...
                                    <form method="POST" autocomplete="off" action="?c=<?php echo $this->name; ?>&a=destroy" role="form">
                                        ...
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="id" name="idempresa" placeholder="id" disabled="" value="<?php echo $data['equipos_marcas'][0]['id']; ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="nombre">Nombre</label>
                                                <input type="text" name="nombre" class="form-control" id="nombre"  disabled="" placeholder="nombre" value="<?php echo $data['equipos_marcas'][0]['nombre']; ?>">
                                            </div>
                                        </div>
